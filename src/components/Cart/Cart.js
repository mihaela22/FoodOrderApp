...
const Cart = (props) => {
  ...
  // bind pre-configure a function for future execution and basically allows you to
  // pre-configure the argument that function will receive when it's being executed.
